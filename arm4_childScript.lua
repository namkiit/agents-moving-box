...
function sysCall_init()
    ...
    RefPosition = sim.getObjectHandle("ReferencePos4")
    EndEffector = sim.getObjectHandle("EndEffector4")
    Connector = sim.getObjectHandle("Connector4")
    Proximity = sim.getObjectHandle("Proximity4")
    Goal = sim.getObjectHandle("GoalPos4")
    Box = sim.getObjectHandle("Box")
    via = sim.getObjectHandle("viaPos4")
    sensorHandle = sim.getObjectHandle("Sensor3")
